...
execute if score timer upmc.stage1.wire matches 251.. if score price upmc.stage1.wire matches 1501.. run scoreboard players set passed1 upmc.logic.disposable 1
